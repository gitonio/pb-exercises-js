...
describe('S256Test', function() {
	...
	it('test_pubpoint', function() {
		...
		points = [
            ...
            {secret: '340282366920938463463374607431768211456', x: '0x8f68b9d2f63b5f339239c1ad981f162ee88c5678723ea3351b7b444c9ec4c0da', y: '0x662a9f2dba063986de1d90c2b6be215dbbea2cfe95510bfdf23cbf79501fff82'},
            {secret: '1766847064778384329583297500742918515827483896875618958121606203440103424', x: '0x9577ff57c8234558f293df502ca4f09cbc65a6572c842b39b366f21717945116', y: '0x10b49c67fa9365ad7b90dab070be339a1daf9052373ec30ffae4f72d5e66d053'}

		]
		points.map(obj => {
			point = new ecc.S256Point(BigInt(obj.x), BigInt(obj.y));
	...
	it('test_sec', function() {
		...
		let uncompressed = BigInt('0x049d5ca49670cbe4c3bfa84c96a8c87df086c6ea6a24ba6b809c9de234496808d56fa15cc7f3d38cda98dee2419f415b7513dde1301f8643cd9245aea7f3f911f9');
		let compressed = BigInt('0x039d5ca49670cbe4c3bfa84c96a8c87df086c6ea6a24ba6b809c9de234496808d5');
		point = G.rmul(coefficient);
		assert.deepEqual(point.sec(false), Buffer.from('049d5ca49670cbe4c3bfa84c96a8c87df086c6ea6a24ba6b809c9de234496808d56fa15cc7f3d38cda98dee2419f415b7513dde1301f8643cd9245aea7f3f911f9','hex'))
		assert.deepEqual(point.sec(true), Buffer.from('039d5ca49670cbe4c3bfa84c96a8c87df086c6ea6a24ba6b809c9de234496808d5','hex'))

		coefficient = BigInt(123);
		//uncompressed = BigInt('0x04a598a8030da6d86c6bc7f2f5144ea549d28211ea58faa70ebf4c1e665c1fe9b5204b5d6f84822c307e4b4a7140737aec23fc63b65b35f86a10026dbd2d864e6b','hex'));
		//compressed = BigInt('0x03a598a8030da6d86c6bc7f2f5144ea549d28211ea58faa70ebf4c1e665c1fe9b5','hex'));
		point = G.rmul(coefficient);
		assert.deepEqual(point.sec(false), Buffer.from('04a598a8030da6d86c6bc7f2f5144ea549d28211ea58faa70ebf4c1e665c1fe9b5204b5d6f84822c307e4b4a7140737aec23fc63b65b35f86a10026dbd2d864e6b','hex'))
		assert.deepEqual(point.sec(true), Buffer.from('03a598a8030da6d86c6bc7f2f5144ea549d28211ea58faa70ebf4c1e665c1fe9b5','hex'))
		
		coefficient = BigInt(42424242);
		//uncompressed = BigInt('0x04aee2e7d843f7430097859e2bc603abcc3274ff8169c1a469fee0f20614066f8e21ec53f40efac47ac1c5211b2123527e0e9b57ede790c4da1e72c91fb7da54a3','hex'));
		//compressed = BigInt('0x03aee2e7d843f7430097859e2bc603abcc3274ff8169c1a469fee0f20614066f8e','hex'));
		point = G.rmul(coefficient);
		assert.deepEqual(point.sec(false), Buffer.from('04aee2e7d843f7430097859e2bc603abcc3274ff8169c1a469fee0f20614066f8e21ec53f40efac47ac1c5211b2123527e0e9b57ede790c4da1e72c91fb7da54a3','hex'))
		assert.deepEqual(point.sec(true), Buffer.from('03aee2e7d843f7430097859e2bc603abcc3274ff8169c1a469fee0f20614066f8e','hex'))
	...
	it('mainnet_address', function () {
		...
		it('test verify', function () {
			...
			z = BigInt('ec208baa0fc1c19f708a9ca96fdeff3ac3f230bb4a7ba4aede4942ad003c0f60', 16);
			r = BigInt('ac8d1c87e51d0d441be8b3dd5b05c8795b48875dffe00b7ffcfac23010d3a395', 16)
			s = BigInt('68342ceff8935ededd102dd876ffd6ba72d6a427a3edb13d26eb0781cb423c4', 16);
		...
		it('test parse', function() {
			...
			want = BigInt('a56c896489c71dfc65701ce25050f542f336893fb8cd15f4e8e5c124dbf58e47', 16)
