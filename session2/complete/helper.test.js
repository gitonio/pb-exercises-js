...
describe('test_encode_base58_checksum', function() {
  it('checks', function() {
    raw = Buffer.from('005dedfbf9ea599dd4e3ca6a80b333c472fd0b3f69', 'hex');
    want = '19ZewH8Kk1PDbSNdJ97FP4EiCjTRaZMZQA';
    assert.equal(helper.encodeBase58Checksum(raw), want);
  });
});
